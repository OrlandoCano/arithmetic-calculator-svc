...
@Component
public class DivisionStrategy extends OperationStrategy {
  ...
  public String performOperation(BaseOperationRequest request) {
    ...
    RecordDto.Builder newRecord = createRecord(DIVISION);
    ...
    newRecord.withOperationResponse("Division Applied Result=" + result);
    recordService.saveRecord(newRecord.build());
