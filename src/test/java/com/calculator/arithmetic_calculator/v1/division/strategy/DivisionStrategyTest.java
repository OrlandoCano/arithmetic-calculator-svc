...
class DivisionStrategyTest {
  ...
  private DivisionStrategy subject;
  private DivisionRequest request;
  ...
  public void init() {
    openMocks(this);
    subject = new DivisionStrategy(operationService, recordService, userService);
    request = new DivisionRequest(10.0, 5.0);
